    ...
    miniShop2.Cart = {
        ...
        status: function (status) {
            if (status['total_count'] < 1) {
                ...
                $(miniShop2.Cart.totalDiscount).html(miniShop2.Utils.formatPrice(status['total_discount'])+"&nbsp;&#8381;");
    ...
    miniShop2.Order = {
        ...
        getcost: function () {
            ...
            callbacks.getcost.response.success = function (response) {
                ...
                $(miniShop2.Order.cartCost, miniShop2.Order.order).html(miniShop2.Utils.formatPrice(response.data['cart_cost'])+"&nbsp;&#8381;");
                $(miniShop2.Order.deliveryCost, miniShop2.Order.order).html(miniShop2.Utils.formatPrice(response.data['delivery_cost'])+"&nbsp;&#8381;");
                $(miniShop2.Order.totalDiscount, miniShop2.Order.order).html(miniShop2.Utils.formatPrice(response.data['total_discount'])+"&nbsp;&#8381;");
            };
            var data = {};
